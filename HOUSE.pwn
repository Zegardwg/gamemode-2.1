...
House_Type(houseid)
{
	if(hData[houseid][hType] == 1)
	{
	    switch(random(2))
		{
			case 0:
			{
				hData[houseid][hIntpos][0] = 845.89;
				hData[houseid][hIntpos][1] = -2048.00;
				hData[houseid][hIntpos][2] = 1476.91;
				hData[houseid][hIntpos][3] = 92.60;
	...
	if(hData[houseid][hType] == 2)
	{
	    switch(random(2))
		{
			case 0:
			{
				hData[houseid][hIntpos][0] = 302.74;
				hData[houseid][hIntpos][1] = 1774.35;
				hData[houseid][hIntpos][2] = 514.65;
				hData[houseid][hIntpos][3] = 0.35;
				hData[houseid][hInt] = 1;
			}
			case 1:
			{
	...
	if(hData[houseid][hType] == 3)
	{
	    switch(random(4))
		{
			case 0:
			{
				hData[houseid][hIntpos][0] = 1855.38;
				hData[houseid][hIntpos][1] = -1709.12;
				hData[houseid][hIntpos][2] = 1720.06;
				hData[houseid][hIntpos][3] = 273.58;
				hData[houseid][hInt] = 1;
			}
			case 1:
			{
				hData[houseid][hIntpos][0] = 4577.82;
				hData[houseid][hIntpos][1] = -2527.82;
				hData[houseid][hIntpos][2] = 5.28;
				hData[houseid][hIntpos][3] = 262.63;
				hData[houseid][hInt] = 1;
			}
			case 2:
			{
				hData[houseid][hIntpos][0] = 1263.68;
				hData[houseid][hIntpos][1] = -605.30;
				hData[houseid][hIntpos][2] = 1001.08;
				hData[houseid][hIntpos][3] = 189.50;
				hData[houseid][hInt] = 1;
			}
			case 3:
			{
				hData[houseid][hIntpos][0] = 1224.34;
				hData[houseid][hIntpos][1] = -749.22;
				hData[houseid][hIntpos][2] = 1085.72;
				hData[houseid][hIntpos][3] = 265.59;
				hData[houseid][hInt] = 1;
			}
			/*case 0:
			{

...
Family_Refresh(id)
{
	if(id != -1)
	{
		...
		format(mstr,sizeof(mstr),"%s", fData[id][fName]);
		fData[id][fPickext] = CreateDynamicPickup(1254, 23, fData[id][fExtpos][0], fData[id][fExtpos][1], fData[id][fExtpos][2], 0, 0);
		fData[id][fLabelext] = CreateDynamic3DTextLabel(mstr, -1, fData[id][fExtpos][0], fData[id][fExtpos][1], fData[id][fExtpos][2]+0.35, 15.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0);

        if(fData[id][fIntpos][0] != 0.0 && fData[id][fIntpos][1] != 0.0 && fData[id][fIntpos][2] != 0.0)
        {
            //fData[id][fLabelint] = CreateDynamic3DTextLabel(mstr, -1, fData[id][fIntpos][0], fData[id][fIntpos][1], fData[id][fIntpos][2]+0.7, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, fData[id][fInt]);
            fData[id][fPickint] = CreateDynamicPickup(1254, 23, fData[id][fIntpos][0], fData[id][fIntpos][1], fData[id][fIntpos][2], 0, fData[id][fInt], -1, 7);
        }
